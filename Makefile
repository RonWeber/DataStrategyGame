CXX = g++
CXXFLAGS = -Wall --coverage -Wno-unknown-pragmas -std=c++11  -O3 -I /usr/include/lua5.1 -I include/ -I /usr/include/SDL2 -I /usr/include/GL -D_GNU_SOURCE=1 -D_REENTRANT  -DPRETTY_SAVE_FILES -g
